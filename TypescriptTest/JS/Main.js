...
GetIt.Students.push(new Student("Henrik", "Bjørhall", 27, "A", GetIt.Teacher), new Student("Patrick", "Johnsen", 24, "A", GetIt.Teacher), new Student("Ibrahim", " ", 0, "A", GetIt.Teacher));
GetIt.Show();
