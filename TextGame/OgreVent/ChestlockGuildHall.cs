            ...
            if (Program.Location == "Chestlock Guild Hall")
            {
                switch (MyAction.ToUpper())
                {
                    ...
                    case "LOOK BACK":
                        ...
                        break;
                    case "TALK TO CLERK":
                        Poster.Post("waiting in line seems to take forever and you eventually you reach the clerk who informs you that you must live in the city in order to use the banks services, 'regulations' she says in a snarky tone");
                        break;
                    case "ENTER OFFICE":
